      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4 neon-text">
            <span className="text-cyber-500">CONTACT</span> US
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto mb-12">
          {/* Contact Form */}
          <div>
            <h2 className="text-2xl font-bold text-cyber-500 mb-6 flex items-center">
          ...
          <div>
            ...
            <div className="cyber-card p-8 space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-cyber-400 mb-2">会社名</h3>
                <p className="text-cyber-200">合同会社ピーチ</p>
              </div>
              <div className="section-divider opacity-30"></div>
              <div>
                <h3 className="text-lg font-semibold text-cyber-400 mb-2">所在地</h3>
              ...
              <div className="section-divider opacity-30"></div>
              <div>
                <h3 className="text-lg font-semibold text-cyber-400 mb-2">メールアドレス</h3>
                <a
                  href="mailto:peach.2023.7.19@gmail.com"
                  className="text-cyber-500 hover:text-cyber-300 transition-colors break-all"
                >
              ...
              <div className="section-divider opacity-30"></div>
              <div>
                <h3 className="text-lg font-semibold text-cyber-400 mb-2">営業時間</h3>
                <p className="text-cyber-200">
                  平日 10:00 - 18:00<br />
                  (土日祝日は休業)
                </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="cyber-card p-8 bg-gradient-to-br from-cyber-500/10 to-neon-purple/10 border-2 border-cyber-500/30">
            <h3 className="text-xl font-bold text-cyber-500 mb-4">お問い合わせについて</h3>
